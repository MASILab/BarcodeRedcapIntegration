...
class RedcapLabelwriterApp_v3(QMainWindow):
    ...
    def __init__(self):
        super().__init__()
        self.title = 'DoD Redcap LabelPrinter Toolkit_v2'
        self.left = 10
        self.top = 10
        self.width = 800 # 400
        self.height = 585 # 585
        ...
        f_redcap_key = open("/app/v2/PrinterApp_v2/REDCAP_API_KEY.txt", "r")
    ...
    def initUI(self):
        ...
        self.cb_study_type.addItems(["UC_ENDO", "CD_ENDO", "CTL_ENDO", "UC_Surgery","CD_Surgery","CTL_Surgery"])    
...
#        self.cb_processed_by.setCurrentIndex(1)
        ...
        pixmap = QPixmap('/app/v2/PrinterApp_v2/masi.png')
...
#                                       'Distributed to Vantage'])   
        ...
        pixmap = QPixmap('/app/v2/PrinterApp_v2/VUMC.png')
    ...
    def getNextSubject(self):
        ...
        if len(barcodeSubset) == 0 :
            ...
            for x in barcodeSubsetList:
                printBarcodeSubsetList.append(int(x[4:7])) # GCAxxx -> DoD_xxx
...
#            last_print_subj = record_list[len(record_list)-1][3:6]
            ...
            last_print_subj = last_record_list[2][4:7] # index 2 is 'barcode_sample_id', sample_id is now DoD_xxx
...
# we use DoD ID: DoD_xxx
            bool_update_redcap_sophie = self.redcapExec.update_REDCAP_SOPHIE(self.studyType,'DoD_%s' %self.subjectId,tmp_barcode_list,self.custom_option)

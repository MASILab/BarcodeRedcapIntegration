...
class RedcapHelper:
    ...
    def get_unique_import(self, to_import):
        ...
        for elem in to_import:
            tmpKey = elem.get('record_id_dem_endo')
...
#         response = self.project.import_records(to_import,overwrite='overwrite')
        self.to_import_list_overwrite.append(to_import)
        print('?????4%s' % len(self.to_import_list_overwrite))
        return True
...
#         response = self.project.import_records(to_import,overwrite='overwrite')
        self.to_import_list_overwrite.append(to_import)
        print('?????5%s' % len(self.to_import_list_overwrite))
        return True
...
#         response = self.project.import_records(to_import,overwrite='overwrite')
        self.to_import_list_overwrite.append(to_import)
        print('?????6%s' % len(self.to_import_list_overwrite))
        return True  
...
#         response = self.project.import_records(to_import,overwrite='overwrite')
        self.to_import_list_overwrite.append(to_import)
        print('?????7%s' % len(self.to_import_list_overwrite))
        return True          
...
#         response = self.project.import_records(to_import,overwrite='overwrite')
        self.to_import_list_overwrite.append(to_import)
        print('?????8%s' % len(self.to_import_list_overwrite))
        return True 
...
#         response = self.project.import_records(to_import,overwrite='overwrite')
        self.to_import_list_overwrite.append(to_import)
        print('?????10%s' % len(self.to_import_list_overwrite))
        return True 
...
#         response = self.project.import_records(to_import,overwrite='overwrite')
        self.to_import_list_overwrite.append(to_import)
        print('?????11%s' % len(self.to_import_list_overwrite))
        return True 

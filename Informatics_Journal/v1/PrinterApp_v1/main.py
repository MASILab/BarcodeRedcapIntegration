...
class RedcapLabelwriterApp_v3(QMainWindow):
    ...
    def __init__(self):
        ...
        f_redcap_key = open("/app/v1/PrinterApp_v1/REDCAP_API_KEY.txt", "r")
...
#        self.cb_processed_by.setCurrentIndex(1)
        ...
        pixmap = QPixmap('/app/v1/PrinterApp_v1/masi.png')
...
#             bool_update_redcap_sophie = self.redcapExec.update_REDCAP_SOPHIE_EXTRA_SERUM(self.studyType,str(int(self.subjectId)),tmp_barcode_list)

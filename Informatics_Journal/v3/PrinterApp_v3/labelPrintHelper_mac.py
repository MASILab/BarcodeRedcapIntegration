...
#         barcode_image.save(barcode_path)
    ...
    def genLabel(self):
        ...
        font = ImageFont.truetype("/app/v3/PrinterApp_v3/Arialn.ttf")

        textBox_size = (200,100)
        text_img = Image.new('RGBA', textBox_size, "white")
        # put text on label
        text_draw = ImageDraw.Draw(text_img)
        font = ImageFont.truetype("/app/v3/PrinterApp_v3/Arialn.ttf", 12) # 40 is font size
        ...
        # paste patence sample ID number to cycle
        textBox_size = (30,40)
        text_img = Image.new('RGBA', textBox_size, "white")
        # put text on label
        text_draw = ImageDraw.Draw(text_img)
        font = ImageFont.truetype("/app/v3/PrinterApp_v3/Arialn.ttf", 22) # 40 is font size
        tmp_sample_id = self.uId.split('_')[1]
        # text_draw.text((0, 0), '999', font=font,fill=(0,0,0,255))  
        text_draw.text((0, 0), tmp_sample_id, font=font,fill=(0,0,0,255))  

        text_img_rotate = text_img.rotate(90)
        source_img.paste(text_img_rotate, (0,40))

...
#         return self.getRecordFromRedcap(['cd_arm_1','control_arm_1','cd_arm_2','control_arm_2'],['record_id_dem_endo'])
    ...
    def getInputPatient(self):
        ...
        """
        # remove fileds...
        # return self.project.export_records(events=['uc_arm_1','cd_arm_1','control_arm_1','uc_arm_2','cd_arm_2','control_arm_2','cancer_arm_2'])
        return self.project.export_records(events=['bccma_arm_1'])
...
#        subset = self.project.export_records(events=['action_tuple_table_arm_3'],fields=['barcode_sample_id'])
    ...
    def getSubjectLastestCustomOption(self, barcode_id,subject_id):
        ...
        if len(df) == 0:
            ...
            tmp_custom_option = ''
            while idx >= 0:
                tmp_subj = tmp_subset[idx].get('barcode_sample_id')[4:7] # DoD_xxx -> xxx
...
#    def setReprintedAction(self, actionId, barcode_id, studyType,processed_by,action_type,action_comment,ean8_code):
    def setAction(self, actionId, barcode_id, studyType,processed_by,action_type,action_comment,ean8_code,custom_option):
        ...
        aliquot_id = ''
        if 'SR' in barcode_id: 
            aliquot_id = barcode_id[10:] # CMA_xxx_SR_1-10 SR1, SR2, SR3, ... SR8
...
################# UPDATE KATE's REDCAP
    def update_REDCAP_KATE(self,study_type,subject_id,barcode_id_list,custom_option):
        # fresh is '' so no need to worry if it is empty... hacking fun
        # SHUNXING: PLEASE ADD UC CASES
        
        tmp_redcap_event_name = ''
        if study_type == 'CMA_PTSD':
            tmp_redcap_event_name = 'bccma_arm_1'
        
        # no matter default or selecting need additional TI, we won't fill up the fresh/fixed/frozen 
        # table until we actually store the biopsies, so the condition is actually simple here. 
        to_import = [{'record_id':subject_id,
                      'redcap_event_name':tmp_redcap_event_name,
                      'stool_yn':'1',
                      'stool_processed_by':'1',
                      'specimen_serum_processed':'1',
                      'stool_aliquot_quant':'4',
                      'id_stool_1':barcode_id_list[0],
                      'id_stool_2':barcode_id_list[1],
                      'id_stool_3':barcode_id_list[2],
                      'id_stool_4':barcode_id_list[3],
                      'serum_yn':'1',
                      'serum_aliquots_100ul':'4',
                      'serum_aliquots_250ul':'4',
                      'serum_aliquots_500ul':'3',
                      'aliquot1_100ul_serum_1':barcode_id_list[4],
                      'aliquot2_100ul_serum_2':barcode_id_list[5],
                      'aliquot3_100ul_serum_3':barcode_id_list[6],
                      'aliquot4_100ul_serum_4':barcode_id_list[7],
                      'aliquot5_250ul_serum_5':barcode_id_list[8],
                      'aliquot6_250ul_serum_6':barcode_id_list[9],
                      'aliquot7_250ul_serum_7':barcode_id_list[10],
                      'aliquot8_250ul_serum_8':barcode_id_list[11],
                      'aliquot9_500ul_serum_9':barcode_id_list[12],
                      'aliquot10_500ul_serum_10':barcode_id_list[13],
                      'aliquot11_500ul_serum_11':barcode_id_list[14],
                      'biopsies_yn':'1'}]
        response = self.project.import_records(to_import)
        return True  
    
    def update_REDCAP_REGINA(self,study_type,subject_id,barcode_id_list,custom_option):
        # fresh is '' so no need to worry if it is empty... hacking fun
        # SHUNXING: PLEASE ADD UC CASES
        ...
        to_import = [{'record_id':subject_id,
                      'redcap_event_name':tmp_redcap_event_name,
                      'stool_processed_by':'2',
                      'specimen_serum_processed':'2',
                      'stool_yn':'1',
                      'stool_aliquot_quant':'4',
                      'id_stool_1':barcode_id_list[0],
                      'id_stool_2':barcode_id_list[1],
...
#                                 'specimen_serum_al_100':'4',
#                                 'specimen_serum_al_1_100_id':barcode_id_list[0],
#                                 'specimen_serum_al_2_100_id':barcode_id_list[1],
#                                 'specimen_serum_al_3_100':barcode_id_list[2],
#                                 'specimen_serum_al_4_100':barcode_id_list[3],
#                                 'specimen_serum_al_250':'4',
#                                 'specimen_serum_al_250_1':barcode_id_list[4],
#                                 'specimen_serum_al_250_2':barcode_id_list[5],
#                                 'specimen_serum_al_250_3':barcode_id_list[6],
#                                 'specimen_serum_al_250_4':barcode_id_list[7],
#                                 'specimen_serum_al_500':'3',
...
#                                 'specimen_dna_id':barcode_id_list[11],
#                                 'cd_endo_biopsy_id':barcode_id_list[14],
#                                 'cd_endo_biopsy_id2':barcode_id_list[15],
#                                 'cd_endo_biopsy_id3':barcode_id_list[16]}]
#             #for hacking surgery patients
#             elif study_type == 'UC_Surgery' or study_type == 'CD_Surgery' or study_type == 'CTL_Surgery' or study_type == 'Cancer_Surgery':
#                 to_import = [{'record_id':subject_id,
#                                 'redcap_event_name':tmp_redcap_event_name,
#                                 'dna_collected_endo_cd_v2':'1',
#                                 'specimen_dna_id':barcode_id_list[11],
...
#                                 'cd_endo_biopsy_id2':barcode_id_list[15],
#                                 'cd_endo_biopsy_id3':barcode_id_list[16],
#                                 'cd_endo_biopsy_id4':barcode_id_list[19],
#                                 'cd_endo_biopsy_id5':barcode_id_list[20],
#                                 'cd_endo_biopsy_id6':barcode_id_list[21]}]
            # response = self.project.import_records(to_import)
...
#         # fresh is '' so no need to worry if it is empty... hacking fun
        ...
        #                       'cd_endo_biopsy_id2':barcode_id_list[15],
        #                       'cd_endo_biopsy_id3':barcode_id_list[16],
        #                       'cd_endo_biopsy_id4':barcode_id_list[22]}] 
        #         # 'DoD_013_SR1', 'DoD_013_SR2', 'DoD_013_SR3', 'DoD_013_SR4', 'DoD_013_SR5', 'DoD_013_SR6', 'DoD_013_SR7', 'DoD_013_SR8', 'DoD_013_SR9', 'DoD_013_SR10', 'DoD_013_SR11', 'DoD_013_DNA', 'DoD_013_Fresh', 'DoD_013_Fixed', 'DoD_013_Frozen_1', 'DoD_013_Frozen_2', 'DoD_013_Frozen_3', '', '', '', '', '', 'DoD_013_AddFrozen', 'DoD_013_NDAddFrozen', 22 is the AddFrozen
                
        #         #print('wocaonimeia : %s' % barcode_id_list)
        #     elif study_type == 'UC_Surgery' or study_type == 'CD_Surgery' or study_type == 'CTL_Surgery' or study_type == 'Cancer_Surgery':
        #         to_import = [{'record_id':subject_id,
        #                       'redcap_event_name':tmp_redcap_event_name,
        #                       'dna_collected_endo_cd_v2':'1',
        ...
        #                       'cd_endo_biopsy_id5':barcode_id_list[20],
        #                       'cd_endo_biopsy_id6':barcode_id_list[21],
        #                       'cd_endo_biopsy_id7':barcode_id_list[22],
        #                       'cd_endo_biopsy_id8':barcode_id_list[23]}]
                
        #     response = self.project.import_records(to_import)
        # return True  
            
#     def update_UC_ENDO_SOPHIE(self,subject_id,barcode_id_list):
        
#         to_import = [{'record_id':subject_id,
#                         'redcap_event_name':'uc_arm_1',
#                         'serum_collected_endo_cd_v2':'1',
#                         'specimen_serum_al_100':'4',
#                         'specimen_serum_al_1_100_id':barcode_id_list[0],
#                         'specimen_serum_al_2_100_id':barcode_id_list[1],
...
#                         'specimen_serum_al_500_2':barcode_id_list[9],
#                         'specimen_serum_al_500_3':barcode_id_list[10],
# #                         'specimen_serum_al_500_4':barcode_id_list[7],
# #                         'specimen_serum_al_500_5':barcode_id_list[8],
# #                         'specimen_serum_al_500_6':barcode_id_list[9],
# #                         'specimen_serum_al_500_7':barcode_id_list[10],
#                         'dna_collected_endo_cd_v2':'1',
#                         'specimen_dna_id':barcode_id_list[11],
# #                         'cd_endo_ti_a_fresh_id':barcode_id_list[12],
# #                         'sc_endo_ti_a_fixed_id':barcode_id_list[13],
# #                         'cd_endo_ti_a_frozen_id':barcode_id_list[14],
...
#     def update_CD_ENDO_SOPHIE(self,subject_id,barcode_id_list):
#         to_import = [{'record_id':subject_id,
...
#     def update_CTL_ENDO_SOPHIE(self,subject_id,barcode_id_list):
#         to_import = [{'record_id':subject_id,
...
#     def update_UC_Surgery_SOPHIE(self,subject_id,barcode_id_list):
#         to_import = [{'record_id':subject_id,
#                         'redcap_event_name':'uc_arm_2',
#                         'serum_collected_endo_cd_v2':'1',
#                         'specimen_serum_al_100':'4',
#                         'specimen_serum_al_1_100_id':barcode_id_list[0],
#                         'specimen_serum_al_2_100_id':barcode_id_list[1],
...
#     def update_UC_ENDO_SOPHIE_extra_frozen(self,subject_id,barcode_id_list):
...
#                         'cd_endo_biopsy_id2':barcode_id_list[15],
#                         'cd_endo_biopsy_id3':barcode_id_list[16],
#                         'cd_endo_biopsy_id4':barcode_id_list[17]}]
#         response = self.project.import_records(to_import)
#         return True 
    
#     def update_CD_ENDO_SOPHIE_extra_frozen(self,subject_id,barcode_id_list):
#         to_import = [{'record_id':subject_id,
#                         'redcap_event_name':'cd_arm_1',
#                         'serum_collected_endo_cd_v2':'1',
#                         'specimen_serum_al_100':'4',
...
#     def update_CTL_ENDO_SOPHIE_extra_frozen(self,subject_id,barcode_id_list):
#         to_import = [{'record_id':subject_id,
#                         'redcap_event_name':'control_arm_1',
#                         'serum_collected_endo_cd_v2':'1',
#                         'specimen_serum_al_100':'4',
...
#     def update_UC_Surgery_SOPHIE_extra_frozen(self,subject_id,barcode_id_list):
#         to_import = [{'record_id':subject_id,
#                         'redcap_event_name':'uc_arm_2',
#                         'serum_collected_endo_cd_v2':'1',
#                         'specimen_serum_al_100':'4',
...
#                         'specimen_serum_al_250_1':barcode_id_list[3],
#                         'specimen_serum_al_500':'7',
#                         'specimen_serum_al_500_1':barcode_id_list[4],
#                         'specimen_serum_al_500_2':barcode_id_list[5],
#                         'specimen_serum_al_500_3':barcode_id_list[6],
#                         'specimen_serum_al_500_4':barcode_id_list[7],
#                         'specimen_serum_al_500_5':barcode_id_list[8],
#                         'specimen_serum_al_500_6':barcode_id_list[9],
#                         'specimen_serum_al_500_7':barcode_id_list[10],
